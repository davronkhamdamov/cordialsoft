                ...
                >
                  ...
                  >
                    ...
                    >
                      {/* Glow */}
                      <div
                        className={`absolute inset-0 bg-gradient-to-br ${step.gradient} rounded-[1.25rem] blur-xl opacity-50 group-hover:opacity-100 transition-opacity`}
                      />

                      <div
                        className={`relative w-16 h-16 bg-gradient-to-br ${step.gradient} rounded-[1.25rem] flex items-center justify-center shadow-lg`}
                      >
                    ...
                    <div
                      className={`absolute -inset-0.5 bg-gradient-to-r ${step.gradient} opacity-0 group-hover:opacity-20 rounded-[2rem] blur-xl -z-10 transition-all duration-500`}
                    />
                  </motion.div>
