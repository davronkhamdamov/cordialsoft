...
const services = [
  ...
  },
  {
    ...
    description:
      "Clean, efficient code that powers fast and reliable web applications",
  ...
  },
  {
    ...
    title: "Landing Pages",
    description:
      "High-converting landing pages optimized for user engagement and conversions",
  ...
  },
  {
    ...
    description:
      "Interactive learning platforms designed for students and educators",
...
export function Services() {
  ...
  return (
    <section
      id="services"
      ref={ref}
      className="py-32 bg-gradient-to-b from-[#F4F8FB] to-white relative overflow-hidden"
    >
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <h3 className="mb-3 relative text-[#1F2937]">
                    {service.title}
                  </h3>
                  <p className="text-[#1F2937]/70 relative leading-relaxed">
                    {service.description}
                  </p>
        ...
        >
          <div className="glass-strong rounded-[2rem] p-8 max-w-4xl mx-auto shadow-xl shadow-[#5DA9E9]/10">
            <p className="text-[#1F2937]/70 text-lg">
              <span className="text-[#5DA9E9] font-semibold">
                All services include
              </span>{" "}
              responsive design, performance optimization, SEO best practices,
              and ongoing support to ensure your digital success.
            </p>
          </div>
        </motion.div>
      </div>
